...
class _$LocationEntityImpl implements _LocationEntity {
  const _$LocationEntityImpl({required this.id, required this.value});
  ...
  @override
  String toString() {
    return 'LocationEntity(id: $id, value: $value)';
  }
...
abstract class _LocationEntity implements LocationEntity {
  const factory _LocationEntity(
      ...
      required final String value}) = _$LocationEntityImpl;
